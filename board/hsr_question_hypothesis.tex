...
Hypothesis: If the original model for the level of immune cells in the weeks
before the onset of type 1 diabetes is analyzed with both a continuously
varying and a static peptide clearance rate $δₚ$, then in the former
analysis, the oscillations present in the original model that indicate the
onset of diabetes will begin later than in the new, latter model because
previous research has shown such behavior is delayed in other systems when
